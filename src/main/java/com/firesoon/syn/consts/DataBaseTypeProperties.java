package com.firesoon.syn.consts;
...
public class DataBaseTypeProperties {
	...
	public static final String SQLSERVER_TYPE_SCALA = "bigint,decimal,float,int,smallint,smallmoney,tinyint,varchar.char,datetime";
